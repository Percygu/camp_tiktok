...
type IsFavoriteVideoReq struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *IsFavoriteVideoReq) Reset() {
	*x = IsFavoriteVideoReq{}
	if protoimpl.UnsafeEnabled {
...
func (x *IsFavoriteVideoReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsFavoriteVideoReq) ProtoMessage() {}

func (x *IsFavoriteVideoReq) ProtoReflect() protoreflect.Message {
	mi := &file_favorite_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsFavoriteVideoReq.ProtoReflect.Descriptor instead.
func (*IsFavoriteVideoReq) Descriptor() ([]byte, []int) {
	return file_favorite_proto_rawDescGZIP(), []int{4}
}

func (x *IsFavoriteVideoReq) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *IsFavoriteVideoReq) GetVideoId() int64 {
	if x != nil {
		return x.VideoId
	}
	return 0
...
type IsFavoriteVideoRsp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *IsFavoriteVideoRsp) Reset() {
	*x = IsFavoriteVideoRsp{}
	if protoimpl.UnsafeEnabled {
...
func (x *IsFavoriteVideoRsp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsFavoriteVideoRsp) ProtoMessage() {}

func (x *IsFavoriteVideoRsp) ProtoReflect() protoreflect.Message {
	mi := &file_favorite_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsFavoriteVideoRsp.ProtoReflect.Descriptor instead.
func (*IsFavoriteVideoRsp) Descriptor() ([]byte, []int) {
	return file_favorite_proto_rawDescGZIP(), []int{5}
}

func (x *IsFavoriteVideoRsp) GetIsFavorite() bool {
	if x != nil {
		return x.IsFavorite
	}
	return false
...
var file_favorite_proto_rawDesc = []byte{
	...
	0x4c, 0x69, 0x73, 0x74, 0x22, 0x48, 0x0a, 0x12, 0x49, 0x73, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69,
	...
	,
...
var file_favorite_proto_goTypes = []interface{}{
	...
	(*IsFavoriteVideoReq)(nil),        // 4: IsFavoriteVideoReq
	(*IsFavoriteVideoRsp)(nil),        // 5: IsFavoriteVideoRsp
	(*CommonResponse)(nil),            // 6: CommonResponse
}
var file_favorite_proto_depIdxs = []int32{
	6, // 0: FavoriteActionRsp.common_rsp:type_name -> CommonResponse
	...
	4, // 3: FavoriteService.IsFavoriteVideo:input_type -> IsFavoriteVideoReq
	1, // 4: FavoriteService.FavoriteAction:output_type -> FavoriteActionRsp
	3, // 5: FavoriteService.GetFavoriteVideoIdList:output_type -> GetFavoriteVideoIdListRsp
	5, // 6: FavoriteService.IsFavoriteVideo:output_type -> IsFavoriteVideoRsp
...
func file_favorite_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_favorite_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IsFavoriteVideoReq); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_favorite_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IsFavoriteVideoRsp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
